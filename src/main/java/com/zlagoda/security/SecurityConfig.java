    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                .authorizeHttpRequests((requests) -> requests
                        ...
                        .requestMatchers("/cashiers").hasAnyAuthority("MANAGER")
                        .requestMatchers("/cashiers-served-all-customers").hasAnyAuthority("MANAGER")
                        .requestMatchers("/cashiers-served-all-customers").hasAnyAuthority("MANAGER")
                        .requestMatchers("/employees/contact").hasAnyAuthority("MANAGER")
                        .requestMatchers("/employees/add").hasAnyAuthority("MANAGER")
                        .requestMatchers("/employees/delete/**").hasAnyAuthority("MANAGER")
                        .requestMatchers("/employees/edit/**").hasAnyAuthority("MANAGER")
                        .requestMatchers("/employees/me").permitAll()
