...
public class EmployeeDaoImpl implements EmployeeDao {
    ...
    public Optional<Employee> findByName(final String name) {
        ...
        List<Employee> employees = namedParameterJdbcTemplate.query(FIND_BY_NAME, parameter, new EmployeeRowMapper());
        return employees.stream().findFirst();
    }

    @Override
    public List<Employee> findAllEmployees() {
        return namedParameterJdbcTemplate.query(FIND_ALL_EMPLOYEES, new EmployeeRowMapper());
    }
    ...
    public Optional<Employee> findById(final String employeeId) {
        ...
        List<Employee> employees = namedParameterJdbcTemplate.query(FIND_BY_ID, parameter, new EmployeeRowMapper());
        return employees.stream().findFirst();
    }
