...
public class CustomerCardDaoImpl implements CustomerCardDao {
    ...
    private static final String FIND_CUSTOMERS_BY_SURNAME =
            "SELECT * FROM Customer_Card WHERE cust_surname = ? ORDER BY cust_surname";
    ...
    public List<CustomerCard> findBySurname(String surname) {
        return jdbcTemplate.query(FIND_CUSTOMERS_BY_SURNAME, new CustomerCardRowMapper(), surname);
    }
}
